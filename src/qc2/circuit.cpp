...
CircuitParallelizer::CircuitParallelizer() {
}

CircuitParallelizer::CircuitParallelizer(const Circuit& circ) {
  auto& gates = circ.getGateList();
  for(const auto& gate : gates)
    this->steps_.emplace_back(gate);
}
